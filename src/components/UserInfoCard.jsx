  ...
  return (
    <div className='userInfoCardMain'>
       ...
       <div className='content'>
          ...
          <p>Seeking Junior-Level React+Node+Next Opportunities | React Js Developer | Node Js, Express Js & MongoDb & Next Js | Software Engineer Student | Islamia University Bahawalpur | 2025 Expected Graduation</p>
       </div>
